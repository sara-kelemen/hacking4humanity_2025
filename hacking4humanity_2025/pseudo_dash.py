...
# Falcon takes awhile, sample output:
st.subheader("AI Generated Social Media Recommendations")
st.markdown("Encourage Constructive Conversations: Approach discussions with an open mind and be respectful.")
